<!--
  ...
  -  *
  -  *  Last modified: 12/12/24, 7:10 pm
            ...
            <div class="mw-lg-950px mx-auto w-100">
                ...
                <div>
                    <div class="d-flex flex-column gap-7 gap-md-10">
                        ...
                        >
                            <div class="flex-root d-flex flex-column">
                                <span class="text-muted">Inward #</span>
                                <span class="fs-5">{{
                            ...
                            <div class="flex-root d-flex flex-column">
                                ...
                                <span class="fs-5">{{
                                    $getDisplayValue(entry, "company.name")
                                }}</span>
                            </div>
                            <div class="flex-root d-flex flex-column">
                                <span class="text-muted">Warehouse</span>
                                <span class="fs-5">{{
                                    $getDisplayValue(entry, "warehouse.name")
                                }}</span>
                            </div>
...
const downloadPdf = async () => {
    return await DownloadService.handleDownload(
        `inwards-single-pdf/${entry.value.id}`
    );
};
</script>
