    ...
    <CardContainer :hide-footer="true">
        <template #header>
            <div class="d-flex align-items-center">
                <RouterLink other title="Back to Purchase Orders" :to="{ name: 'purchase-orders.index' }"
                    ...
                    <div class="d-flex flex-column gap-7 gap-md-10">
                        ...
                        <div class="d-flex flex-column flex-sm-row gap-7 gap-md-10 fw-bold">
                            <div class="flex-root d-flex flex-column">
                                ...
                                <span class="fs-5">{{
                                    $getDisplayValue(entry, "po_number", "-")
                                    }}</span>
                            </div>
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                    <thead>
                                        <tr class="border-bottom fs-6 fw-bold text-muted">
                                            ...
                                            <th v-if="false" class="min-w-70px text-end pb-2">
                                                Supplier Code
                                            </th>
...
const downloadPdf = async () => {
    return await DownloadService.handleDownload(
        `purchase-orders-single-pdf/${entry.value.id}`
    );
};
