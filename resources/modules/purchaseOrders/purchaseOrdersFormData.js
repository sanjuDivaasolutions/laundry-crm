 ...
 *  *
 *  *  Last modified: 16/10/24, 5:25 pm
 *  *  Written by Chintan Bagdawala, 2024.
 *
 */

import { module } from "./purchaseOrdersModule";
...
const formFields = [
    ...
    },
    {
        ...
        label: `general.fields.estimated_delivery_date`,
    ...
    /* {
        name: "price_term",
        label: `general.fields.price_term`,
        field: "price_term",
        placeholder: "Select Price Term",
        idValue: "id",
        labelValue: "name",
        type: "select-single",
        endpoint: "price-terms",
        mode: "single",
        hideSelected: true,
        required: true,
        column: "4",
     ...
     {
        name: "packaging_term",
        label: `general.fields.packaging_term`,
        field: "packaging_term",
        placeholder: "Select Packaging Term",
        idValue: "id",
        labelValue: "name",
        type: "select-single",
        endpoint: "packaging-terms",
        mode: "single",
        hideSelected: true,
        required: true,
        column: "2",
