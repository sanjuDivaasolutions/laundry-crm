...
import { useModuleFormStore } from "@modules@/suppliers/suppliersFormStore";
...
import { defaultEntry } from "./suppliersFormData";
    ...
    switch (props.mode) {
        case "create":
            ApiService.post(moduleFormStore.route, formEntry)
                .then((response) => {
                    $toastSuccess("Supplier Contact Information created successfully");
                    redirectIndex();
                })
                .catch((error) => {
                    $catchResponse(error);
        ...
        case "edit":
            ApiService.put(
                ...
                .then((response) => {
                    $toastSuccess("Supplier Contact Information updated successfully");
                    redirectIndex();
                })
                .catch((error) => {
                    $catchResponse(error);
