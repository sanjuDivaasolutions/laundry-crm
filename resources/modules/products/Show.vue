<!--
  ...
  -  *
  -  *  Last modified: 25/11/24, 4:55 pm
                ...
                >
                    ...
                    <li class="nav-item">
                        <router-link
                            :to="{
                                name: 'products.show',
                                params: { id: id, tab: 'transaction' },
                            }"
                            @click.prevent="switchTab('transaction')"
                            class="nav-link text-active-primary me-6"
