...
<table style="width:100%;border:0;font-family:Arial, Helvetica, sans-serif;font-size: 12px;color:#000000;">
    ...
    @foreach($obj->items as $i)
        ...
        <tr>
            <td colspan="6">
                <table style="width:100%;border:1px solid #000;padding:0;">
                    <tr>
                        <th style="text-align:left;border-right:1px solid #000;border-bottom: 1px solid #000;">Design No</th>
                        <th style="text-align:left;border-right:1px solid #000;border-bottom: 1px solid #000;">Shade No</th>
                        <th style="text-align:left;border-right:1px solid #000;border-bottom: 1px solid #000;">Bale No</th>
                        <th style="text-align:left;border-bottom: 1px solid #000;">Mtrs.</th>
                    </tr>
                    @foreach($i->details as $d)
                    <tr>
                        <td style="border-right:1px solid #000;">{{$d->design_no}}</td>
                        <td style="border-right:1px solid #000;">{{$d->shade_no}}</td>
                        <td style="border-right:1px solid #000;">{{$d->bale_no}}</td>
                        <td>{{$d->mtrs}}</td>
                    </tr>
                    @endforeach
                </table>
